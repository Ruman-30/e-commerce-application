  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-5 md:px-6 py-8 pt-16 sm:pt-20 md:pt-28">
        ...
        {/* Reviews Section */}
        <div className="mt-10 sm:mt-12 px-3 sm:px-0">
          {reviews.length > 0 && (
          ...
          {/* Reviews List */}
          <div className="flex flex-col gap-3 sm:gap-4 max-h-[22rem] overflow-y-auto pr-1 sm:pr-2">
            {reviews.map((review) => (
              <div
                key={review._id}
                className="p-3 sm:p-4 bg-gray-100 rounded-lg shadow-sm hover:shadow-md transition-all duration-300"
              >
                ...
                <span className="text-gray-400 text-[10px] sm:text-xs mt-1 block">
          ...
          {/* Add Review Form */}
          {hasPurchased && (
            <div className="mt-6 p-4 sm:p-5 bg-gray-100 shadow-md rounded-lg">
              ...
              <form onSubmit={handleReviewSubmit}>
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full px-3 sm:px-4 py-2 text-xs sm:text-sm rounded-md bg-white border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-300 resize-none"
                ></textarea>

                <button
                  type="submit"
                  className="mt-3 w-full sm:w-auto bg-blue-600 text-white px-5 sm:px-6 py-2 sm:py-2.5 rounded-lg hover:bg-blue-700 transition text-sm sm:text-base"
                >
                  Submit Review
                </button>
              </form>
